...
function gLizClick() {
  // click user feedback
  b2.classList.remove("z1-color");
  b3.classList.remove("z1-color");
  b4.classList.remove("z1-color");
  b1.classList.add("z1-color");
...
function pLizClick() {
  // click user feedback
  b1.classList.remove("z1-color");
  b3.classList.remove("z1-color");
  b4.classList.remove("z1-color");
  b2.classList.add("z1-color");
...
function moleClick() {
  // click user feedback
  b2.classList.remove("z2-color");
  b3.classList.remove("z2-color");
  b4.classList.remove("z2-color");
  b1.classList.add("z2-color");
...
function mirosClick() {
  // click user feedback
  b1.classList.remove("z2-color");
  b3.classList.remove("z2-color");
  b4.classList.remove("z2-color");
  b2.classList.add("z2-color");
...
function salamanderClick() {
  // click user feedback
  b2.classList.remove("z3-color");
  b3.classList.remove("z3-color");
  b4.classList.remove("z3-color");
  b1.classList.add("z3-color");
...
function jetfishClick() {
  // click user feedback
  b1.classList.remove("z3-color");
  b3.classList.remove("z3-color");
  b4.classList.remove("z3-color");
  b2.classList.add("z3-color");
